...
//注意！！！！！！！！！！！areaInputStartIndexImage专用！！！！！！！！
layout (local_size_x = 1, local_size_y = 1, local_size_z = 1) in;//外部定义group数量,这里定义invocation数量
...
ivec2 AreaBias = ivec2(imageLoad(parameter_image,ivec2(1,0)).xy);//区域索引偏移量
